...
Financials <- read.csv("X Financial Variables.csv")
...
combined3 <- combined2[which(combined2$TDC1 > 1),]

removedCEOs <- combined2[which(combined2$TDC1 <= 1),]
...
# Calculate the components of ev as a percent of mv
combined4$dlc_mv <- combined4$dlc / combined4$mv
combined4$dltt_mv <- combined4$dltt / combined4$mv
combined4$pstk_mv <- combined4$pstk / combined4$mv
combined4$che_mv <- combined4$che / combined4$mv
